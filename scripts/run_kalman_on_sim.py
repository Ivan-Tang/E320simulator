...
from src.baseline import _shared_hit_rejection
...
def evaluate_kalman_on_sim(
    ...
    """Run the Kalman track finder on simulated clusters and evaluate.
...
if __name__ == "__main__":
    ...
    for suffix in suffixs:
        ...
        print(f"\n{'='*60}")
        print(f"  Kalman evaluation on {suffix} set")
        print(f"{'='*60}")
        kalman_result = evaluate_kalman_on_sim(clusters_df, tracks_df)
